...
def new_print_task(num_students):
    num_tasks = 2 * num_students
    new_task_chance = 3600 / num_tasks
    num = random.randrange(1, new_task_chance + 1)
    return num == new_task_chance

# Print 10 trials for the simulation
for i in range(10):
